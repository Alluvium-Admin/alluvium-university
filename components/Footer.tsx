        ...
        <footer className="footer">
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="footer-quicklinks pb-3 col-sm-6 col-lg-4 col-md-6 ps-md-3">
                        <h5 className="text-md-center">Quick Links</h5>
                        <div className="row">
                    ...
                    <div className="footer-quicklinks col-lg-2 col-sm-6 col-md-6 ps-md-5">
                        <h5>Login in as:</h5>
                        <ul className="" >
